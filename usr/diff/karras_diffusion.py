...
class KarrasDenoiser:
    ...
    def training_losses(self, model, x_start, sigmas, model_kwargs=None, noise=None):
        ...
        loss = mean_flat(weights * (denoised - x_start) ** 2)
    ...
    def consistency_losses(
        ...
        def euler_solver(samples, t, next_t, x0):
            ...
            if teacher_model is None:
                ...
                denoiser = teacher_denoise_fn(x, t)
            d = (x - denoiser) / append_dims(t, dims) # t == sigma, here should be t**2, but absorbed a t by next step
            samples = x + d * append_dims(next_t - t, dims)
    ...
    # progress distillation loss in ``Salimans, T. et al. Progressive distillation for fast sampling of diffusion models''
    def progdist_losses(
        self,
        model,
        x_start,
    ...
    def denoise(self, model, x_t, sigmas, **model_kwargs):
        ...
        rescaled_t = 1000 * 0.25 * th.log(sigmas + 1e-44) # scale 1000 times to increase distinguishability
