...
class Block(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, padding=0, dilation=1, stride=1, groups=8):
        super().__init__()
...
class ResBlock(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, padding, dilation, stride=1, groups=8):
        super().__init__()
        self.block = Block(in_channels, out_channels, kernel_size, padding, dilation, stride=1, groups=8)
